<template>
  <div
    class="flex flex-col items-center justify-center text-center bg-white h-screen"
  >
    <div class="m-4">
    ...
    <div class="mb-4 px-4">
      ...
      <div v-for="month in $store.state.months">
        <button
          @click="
            $router.push({
              name: 'year-month-reports',
              params: {
                year: month._id.split('-')[0],
                month: month._id.split('-')[1]
              }
            })
          "
